...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if ([10, 25, 50, 100].includes(savedPageSize)) Promise.resolve().then(() => setPageSize(savedPageSize));
