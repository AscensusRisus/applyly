...
export default function Home() {
  ...
  useEffect(() => {
    ...
    Promise.resolve().then(() => {
      ...
      setForm(current => current.appliedDate ? current : {...current, appliedDate:now.toISOString().slice(0,10)});
    });
