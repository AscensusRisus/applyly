...
- tests/fixtures/structured-jobposting.html, tests/fixtures/linkedin-split-pane.html, and tests/fixtures/workday-collection.html run the real page-context script with a small fixture DOM harness. This verifies extracted company, role, URL, detail/collection mode, nested structured data, and separate generic ATS card behavior.
