...
2. Extraction reliability: add sanitized DOM fixtures for real single-job and feed pages. Prioritize LinkedIn split-pane selected-job behavior and structured JobPosting pages. Test each adapter against a supported fixture before claiming support. Keep manual editing available.
